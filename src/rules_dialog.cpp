...
cz::rules_dialog::rules_dialog(QWidget* parent, const cyto_params& params) :
    ...
    auto* palette_editor_widget = static_cast<palette_editor*>(palette_editor_widget_);
    ...
    palette_editor_widget->set_num_states(params.num_states);
    palette_editor_widget->set_palette(params.palette);

    cell_indexer_combo_->setCurrentText(
        indexer_name_or_default(params.cell_indexer, QStringLiteral("sum of states"))
    );

    vert_indexer_combo_->setCurrentText(
        indexer_name_or_default(params.vertex_indexer, QStringLiteral("sum of states"))
    );
...
cz::cyto_params cz::rules_dialog::get() const {
    ...
    edited.palette = static_cast<palette_editor*>(palette_editor_widget_)->palette();
